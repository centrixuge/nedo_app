...
class Timing extends StatefulWidget {
  ...
  const Timing({Key? key, required this.user, required this.usertype, required this.origin, required this.destination}) : super(key: key);
  @override
        ...
        body: Column(
                    ...
                    children:<Widget>[
                      ...
                      Expanded(
                        child: ConstrainedBox(
                          ...
                          child: ElevatedButton(
                            child: Text("出発希望時刻の選択", textAlign: TextAlign.center, maxLines: 1,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(selectedDate_B == null? "" : "選択した出発時刻", textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                            Text(selectedDate_B == null? "" : strDate_B, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                          ]
                        )
                      )
                    ]
          ...
          Expanded(
                  ...
                  children:<Widget>[
                    ...
                    Expanded(
                        child: ConstrainedBox(
                            constraints: BoxConstraints.expand(height: 40.0),
                            child: ElevatedButton(
                              child: Text("到着希望時刻の選択", textAlign: TextAlign.center, maxLines: 1,
                                  overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                              onPressed: (){
                                showDatePicker_E();
                              },
                    ...
                    Expanded(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(selectedDate_E == null? "" : "選択した到着時刻", textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                            Text(selectedDate_E == null? "" : strDate_E, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                          ],
                        )
                    )
                  ]
              ...
              Expanded(
                  child: Row(
                    children:<Widget>[
                        Expanded(
                            child: Icon(Icons.event_seat_sharp, size:60)
                        ),
                      ...
                      Expanded(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(selectedSeat == null? "" : "選択した座席数", textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                              Text(selectedSeat == null? "" : selectedSeat, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16)),
                            ],
                          )
                      )
                      ]
          ...
          ElevatedButton(
            ...
            // https://www.choge-blog.com/programming/flutterbutton-enabled-disabled/
              onPressed: (selectedDate_B != null && selectedDate_E != null) ? () => _onButtonPressed() : null,
